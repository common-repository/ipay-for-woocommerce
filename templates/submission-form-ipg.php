<form method="POST" action="<?php echo esc_attr($form_url) ?>">
    ...
    <input type="hidden" name="customerPhone" value="<?php echo esc_attr($customer_phone) ?>"/>
    ...
    <input type="hidden" name="checksum" value="<?php echo esc_attr($additional_sec_checksum) ?>"/>
